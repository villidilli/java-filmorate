...
public class UserControllerTest {
    ...
    @Test
    public void createUserWhenLoginWithSpaceReturn400() {
    ...
    @Test
    public void createUserWhenNameIsBlankReturn201() {
        user1.setName(null);
    ...
    @Test
    public void getCommonFriendsUserId1And2Return200() {
        restTemplate.postForEntity("/users", user1, User.class);
        restTemplate.postForEntity("/users", user2, User.class);
        restTemplate.postForEntity("/users", user3, User.class);
    ...
    @Test
    public void getFriendsUserId1FriendId2Return200() {
        restTemplate.postForEntity("/users", user1, User.class);
        restTemplate.postForEntity("/users", user2, User.class);
        restTemplate.exchange(
    ...
    @Test
    public void getFriendsUserId1WhenNotFriendReturn200() {
        restTemplate.postForEntity("/users", user1, User.class);
        ResponseEntity<User[]> users = restTemplate.getForEntity(
                "/users/1/friends", User[].class);
        assertEquals(HttpStatus.OK, users.getStatusCode());
    ...
    @Test
    public void getFriendsUserId1WhenFriend999Return404() {
    ...
    @Test
    public void getCommonFriendsUserId1And2WhenHaveNotFriendsReturn200() {
        restTemplate.postForEntity("/users", user1, User.class);
        restTemplate.postForEntity("/users", user2, User.class);
        restTemplate.postForEntity("/users", user3, User.class);
        restTemplate.exchange(
    ...
    @Test
    public void getUserId1WhenUserCreatedReturn200() {
        restTemplate.postForEntity("/users", user1, User.class);
    ...
    @Test
    public void getUserId1Return404() {
    ...
    @Test
    public void getAllUsersWhenUsersNotHaveReturn200() {
    ...
    @Test
    public void addFriendReturn204() {
        entityUser1 = restTemplate.postForEntity("/users", user1, User.class);
    ...
    @Test
    public void deleteFriendReturn204() {
        entityUser1 = restTemplate.postForEntity("/users", user1, User.class);
        entityUser2 = restTemplate.postForEntity("/users", user2, User.class);
        ResponseEntity response = restTemplate.exchange(
    ...
    @Test
    public void addFriendReturn404() {
        entityUser1 = restTemplate.postForEntity("/users", user1, User.class);
        ResponseEntity<Map> response = restTemplate.exchange(
    ...
    @Test
    public void deleteFriendReturn404() {
        entityUser1 = restTemplate.postForEntity("/users", user1, User.class);
        ResponseEntity<Map> response = restTemplate.exchange(
    ...
    @Test
    public void userUpdateWhenLoginWithSpaceReturn400() {
        user1.setLogin("invalid login");
    ...
    @Test
    public void userUpdateWhenNameIsBlankReturn201() {
        entityUser1 = restTemplate.postForEntity("/users", user1, User.class);
        assertEquals(HttpStatus.CREATED, entityUser1.getStatusCode());
        ...
        entityUser1 = restTemplate.exchange(
                new RequestEntity<>(user1, HttpMethod.PUT, URI.create("/users")), User.class);
